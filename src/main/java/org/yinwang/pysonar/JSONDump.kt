...
object JSONDump {
    ...
    private val seenDef = HashSet<String>()
    private val seenRef = HashSet<String>()
    private val seenDocs = HashSet<String>()
    ...
    private fun writeSymJson(binding: Binding, json: JsonGenerator) {
        ...
        val isExported = !(Binding.Kind.VARIABLE == binding.kind ||
                ...
                name.length == 0 || name[0] == '_' || name.startsWith("lambda%"))
     ...
     */
    @Throws(Exception::class)
    private fun graph(srcpath: String,
